...
<div class = 'container'>
    ...
    <!-- <div class="Box1 mt-5 ">
        ...
        <div class="boxT_1 ">
            <div class="texto_1">
                <p style="text-align: center;">Monsanto é uma aldeia histórica em Portugal, situada no topo de uma colina com vista panorâmica. Foi habitada desde o Paleolítico e possui vestígios arqueológicos de ocupação lusitana, romana, visigótica e árabe. Foi conquistada por D. Afonso Henriques em 1165 e doada aos Templários, que construíram o Castelo. Monsanto resistiu a cercos de invasores e hoje é possível visitar as ruínas do Castelo, a Capela de S. Miguel e a Capela de Santa Maria do Castelo. Também há a Festa de Santa Cruz e a Estação Arqueológica Romana de São Lourenço.</p>
            </div>
        </div>
    </div>
...
<div class="card mb-3 " >
    <div class="row d-flex align-items-center w-100">
        ...
        <div class="col-md-8">
            <div class="card-body">
                <p class="card-text" style="text-align: center;">Monsanto é uma aldeia histórica localizada no centro de Portugal, na região de Idanha a Nova. Situada no topo de uma colina íngreme, 

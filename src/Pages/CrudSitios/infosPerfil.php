      ...
      <section>
        <form enctype="multipart/form-data" action="../../Controladores/controlar-utilizador.php" method="post" class="form-control py-3">
          ...
          <div class="input-group mb-3">
            ...
            <input type="text" class="form-control" name="apelido" maxlength="100" size="100" value="<?= isset($_REQUEST['texto']) ? $_REQUEST['texto'] : $info['texto'] ?>" required>
          </div>
          <div class="input-group mb-3">
            <span class="input-group-text">Tipo</span>
            <input type="text" class="form-control" name="apelido" maxlength="100" size="100" value="<?= isset($_REQUEST['tipo']) ? $_REQUEST['tipo'] : $info['tipo'] ?>" required>
          </div>
          <div class="input-group mb-3">
